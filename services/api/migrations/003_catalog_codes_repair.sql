...
ALTER TABLE incidents RENAME TO incidents_before_catalog_repair;
ALTER TABLE audit_events RENAME TO audit_events_before_catalog_repair;
...
SELECT
    ...
    reporter, client_account, created_at, updated_at, sla_target_at, resolved_at,
    closed_at, created_by, updated_by
FROM incidents_before_catalog_repair;
...
SELECT
    ...
    END,
    reason, correlation_id
FROM audit_events_before_catalog_repair;

DROP TABLE audit_events_before_catalog_repair;
DROP TABLE incidents_before_catalog_repair;
