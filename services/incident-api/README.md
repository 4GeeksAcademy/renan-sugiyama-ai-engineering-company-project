...
The SQLite database is created at `services/incident-api/data/incidents.db` by default. Set `INCIDENT_DB_PATH` to use another location. The initial schema is in [`migrations/001_initial.sql`](./migrations/001_initial.sql).
